        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              >
                <Zap className="w-12 h-12" style={{ color: course.neonColor }} />
              </motion.div>
              <div>
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground">
              <p className="text-lg leading-relaxed">
                Shunya is where young minds discover the magic of electricity. Through creative paper circuit projects, 
                children learn fundamental electronics concepts while creating beautiful, glowing artwork. This foundational 
                course sparks curiosity and builds confidence in STEM through hands-on making.
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <Card className="p-6 border-2 border-border bg-card/50 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                >
                  <Sparkles className="w-6 h-6" style={{ color: course.neonColor }} />
                </div>
                <div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                  Start your journey into electronics with Shunya. Create glowing artwork, 
                  interactive cards, and discover the magic of circuits.
                </p>
                <Button
                  size="lg"
