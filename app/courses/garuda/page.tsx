        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              >
                <Plane className="w-12 h-12" style={{ color: course.neonColor }} />
              </motion.div>
              <div>
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground">
              <p className="text-lg leading-relaxed">
                Garuda takes you to new heights with drone engineering. Master aerodynamics, flight controllers, 
                and GPS navigation. Build autonomous drones capable of complex missions, aerial photography, and FPV flying. 
                This advanced course prepares you for commercial drone applications and certifications.
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <Card className="p-6 border-2 border-border bg-card/50 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                >
                  <Navigation className="w-6 h-6" style={{ color: course.neonColor }} />
                </div>
                <div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                  Master drone engineering with Garuda. Build, program, and fly autonomous drones. 
                  From manual control to fully autonomous missions.
                </p>
                <Button
                  size="lg"
