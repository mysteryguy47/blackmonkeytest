...
const courseProjects = {
  garuda: [
    { title: "Aerial Photography Drone", description: "Capture stunning aerial shots", week: 3, parentOutcome: "Develops photography and aerial skills" },
    { title: "Search & Rescue Mission", description: "Autonomous search patterns", week: 5, parentOutcome: "Builds problem-solving and mission planning skills" },
    { title: "Racing Drone", description: "High-speed FPV racing", week: 7, parentOutcome: "Encourages competitive spirit and precision" },
  ],
};
...
const courseTestimonials = {
  garuda: [
    { name: "Vikram, Age 16", text: "Flying my own drone is incredible! Best experience!", rating: 5, isParent: false },
    { name: "Sneha, Age 15", text: "I captured amazing aerial photos. This course is awesome!", rating: 5, isParent: false },
    { name: "Ravi K.", text: "My son's drone project won a regional competition. The course exceeded our expectations!", rating: 5, isParent: true, childAge: "Age 16" },
  ],
};
...
export default function GarudaPage() {
  const course = coursesData.find((c) => c.id === "garuda");
  ...
  const projects = courseProjects.garuda;
  const kitItems = kitContents.garuda;
  const testimonials = courseTestimonials.garuda;
  const faqs = courseFAQs.garuda;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {course.learningOutcomes.map((outcome, index) => {
                const futureCourseLinks: Record<number, { name: string; color: string }> = {
                  0: { name: "Professional Projects", color: "rgb(168, 85, 247)" },
                  1: { name: "Professional Projects", color: "rgb(168, 85, 247)" },
