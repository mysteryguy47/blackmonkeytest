        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              >
                <Wifi className="w-12 h-12" style={{ color: course.neonColor }} />
              </motion.div>
              <div>
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground">
              <p className="text-lg leading-relaxed">
                Yantra opens the door to the Internet of Things. Learn how to connect everyday objects to the internet, 
                creating smart devices that communicate and respond. Build sensor networks, integrate cloud services, 
                and develop mobile apps to control your IoT creations. Transform your ideas into connected reality.
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <Card className="p-6 border-2 border-border bg-card/50 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                >
                  <Cloud className="w-6 h-6" style={{ color: course.neonColor }} />
                </div>
                <div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                  Build smart connected devices with Yantra. Create your own IoT ecosystem and 
                  bring everyday objects to life with internet connectivity.
                </p>
                <Button
                  size="lg"
