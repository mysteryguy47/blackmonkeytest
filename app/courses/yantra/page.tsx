...
const courseProjects = {
  yantra: [
    { title: "Smart Home Hub", description: "Control lights and devices remotely", week: 4, parentOutcome: "Develops understanding of connected systems" },
    { title: "Weather Station", description: "Monitor temperature and humidity", week: 7, parentOutcome: "Builds data analysis and monitoring skills" },
    { title: "Security System", description: "Motion detection and alerts", week: 10, parentOutcome: "Encourages problem-solving and security awareness" },
  ],
};
...
const courseTestimonials = {
  yantra: [
    { name: "Arjun, Age 13", text: "I made a smart home system. My parents are impressed!", rating: 5, isParent: false },
    { name: "Priya, Age 12", text: "IoT is amazing! I can control things from my phone!", rating: 5, isParent: false },
    { name: "Rajesh K.", text: "My son built a complete weather station. The course structure is excellent for teens.", rating: 5, isParent: true, childAge: "Age 13" },
  ],
};
...
export default function YantraPage() {
  ...
  const projects = courseProjects.yantra;
  const kitItems = kitContents.yantra;
  const testimonials = courseTestimonials.yantra;
  const faqs = courseFAQs.yantra;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {course.learningOutcomes.map((outcome, index) => {
                const futureCourseLinks: Record<number, { name: string; color: string }> = {
                  0: { name: "ANANTA (AI)", color: "rgb(236, 72, 153)" },
                  1: { name: "ANANTA (AI)", color: "rgb(236, 72, 153)" },
                  2: { name: "GARUDA (Drones)", color: "rgb(34, 211, 238)" },
