...
export async function generateMetadata(): Promise<Metadata> {
  ...
  if (!course) {
    return {
      title: "ANANTA - AI Course | BlackMonkey",
      description: "Learn AI with BlackMonkey's advanced course.",
    };
  }

  const courseUrl = `${cleanBaseUrl}/courses/ananta`;
  const ogImage = `${cleanBaseUrl}/generated_images/ananta_product.png`;
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${course.name} Course Kit - AI for Kids`,
        },
      ],
      locale: "en_US",
    },
...
export default function AnantaLayout({
  children,
}: {
