        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <div className="flex items-center gap-4 mb-6">
              ...
              >
                <Bot className="w-12 h-12" style={{ color: course.neonColor }} />
              </motion.div>
              <div>
            ...
            <div className="prose prose-lg max-w-none text-muted-foreground">
              <p className="text-lg leading-relaxed">
                Chakra introduces students to the exciting world of robotics. Build and program robots that move, 
                sense, and respond to their environment. From constructing robot chassis to programming autonomous behaviors, 
                students develop mechanical and computational thinking skills through hands-on projects and competitions.
              </p>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <Card className="p-6 border-2 border-border bg-card/50 backdrop-blur-sm">
              <div className="flex items-center gap-3 mb-3">
                ...
                >
                  <Cpu className="w-6 h-6" style={{ color: course.neonColor }} />
                </div>
                <div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                  Master robotics with Chakra. Build, program, and compete with your own robots. 
                  Transform from beginner to robot master.
                </p>
                <Button
                  size="lg"
