    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Content Section */}
          {courseImageMap[course.id] ? (
            /* Minimal content for courses with product images - just title, age group, and CTA at bottom */
            <div className="relative p-6 flex flex-col justify-between z-10 bg-gradient-to-t from-background/95 via-background/80 to-transparent">
              ...
              >
                <div
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border backdrop-blur-sm"
                  style={{
                    background: `${course.neonColor}15`,
                    borderColor: `${course.neonColor}35`,
                    boxShadow: `0 2px 10px -2px ${course.neonColor}25`,
                  }}
                >
                  <span className="text-xs font-bold" style={{ color: course.neonColor }}>
                    {course.ageGroup}
                  </span>
                </div>
              </motion.div>
            ...
            <div className="relative p-8 flex-1 flex flex-col z-10">
              ...
              {/* Age Group & Duration - Premium Badge */}
              <motion.div
              ...
              >
                <div
                  ...
                  style={{
                    ...
                    boxShadow: `0 2px 8px -2px ${course.neonColor}20`,
                  }}
                >
                  <span className="text-xs font-semibold" style={{ color: course.neonColor }}>
                    {course.ageGroup}
                  </span>
                </div>
